...
/** Universal chrome title for every CLI audience terminal. */
export const CLI_CHROME_TITLE = "PolicyWell Intelligence Agent";
...
export const CLI_AUDIENCES: CliAudience[] = [
  ...
  {
    id: "advisors",
    label: "Advisors & Agencies",
    shortLabel: "Advisors",
    lines: [
      {
        text: "$ policywell advisor book sync --practice northshore",
        tone: "command",
      },
      { text: "✓ 186 client households synced", tone: "success" },
      { text: "✓ 412 in-force policies indexed", tone: "success" },
      { text: "✓ CRM calendar connected", tone: "success" },
      { text: "", tone: "blank" },
      {
        text: "$ policywell reviews due --window 30d --priority high",
        tone: "command",
      },
      { text: "", tone: "blank" },
      { text: "Book health:", tone: "accent" },
      { text: "  Annual reviews due        47", tone: "default" },
      { text: "  Lapse-risk alerts         12", tone: "warn" },
      { text: "  Suitability follow-ups     9", tone: "default" },
      { text: "  Funding gaps flagged      21", tone: "warn" },
      { text: "", tone: "blank" },
      {
        text: "$ policywell client brief --household rivera-family",
        tone: "command",
      },
      { text: "", tone: "blank" },
      { text: "Client brief:", tone: "muted" },
      { text: "  Household          Rivera Family", tone: "default" },
      { text: "  Primary product    IUL", tone: "default" },
      { text: "  Recommendation     Increase funding $180/mo", tone: "default" },
      { text: "  Compliance gate    Human approval required", tone: "warn" },
      { text: "  Meeting ready      Client PDF + talking points", tone: "success" },
      { text: "", tone: "blank" },
      { text: "✓ Advisor-ready report generated", tone: "success" },
      { text: "✓ Tasks queued for licensed review", tone: "success" },
      { text: "", tone: "blank" },
      { text: "Report:", tone: "muted" },
      { text: "  /reports/rivera-family-advisor-brief.pdf", tone: "dim" },
    ],
  },
  {
    id: "imos",
