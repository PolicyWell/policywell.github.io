...
export const CLI_AUDIENCES: CliAudience[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      { text: "", tone: "blank" },
      { text: "Business", tone: "accent" },
      { text: "  Acme Manufacturing", tone: "default" },
      { text: "", tone: "blank" },
      { text: "Industry", tone: "muted" },
      { text: "  Precision Manufacturing", tone: "default" },
      { text: "", tone: "blank" },
      { text: "Employees                     67", tone: "default" },
      { text: "Annual Revenue                $18.2M", tone: "default" },
      { text: "", tone: "blank" },
      { text: "Commercial Risk Score ....... 76", tone: "accent" },
      { text: "Coverage Adequacy ........... Moderate", tone: "warn" },
      { text: "", tone: "blank" },
      { text: "AI Findings", tone: "accent" },
      { text: "  • Cyber coverage below industry norm", tone: "warn" },
      { text: "  • EPLI missing", tone: "warn" },
      { text: "  • Workers Comp limits appropriate", tone: "success" },
      { text: "  • Property values outdated", tone: "warn" },
      { text: "", tone: "blank" },
      { text: "Carrier Matches", tone: "accent" },
      { text: "  ✓ Travelers", tone: "success" },
      { text: "  ✓ Chubb", tone: "success" },
      { text: "  ✓ Hartford", tone: "success" },
      { text: "", tone: "blank" },
      { text: "Recommendations", tone: "accent" },
      { text: "  • Increase cyber limits", tone: "default" },
      { text: "  • Add EPLI", tone: "default" },
      { text: "  • Schedule property valuation", tone: "default" },
      { text: "", tone: "blank" },
      { text: "Other prompts", tone: "muted" },
      { text: "  pw analyze-loss-runs", tone: "dim" },
      { text: "  pw coverage-gap", tone: "dim" },
      { text: "  pw carrier-appetite", tone: "dim" },
      { text: "  pw business-risk", tone: "dim" },
      { text: "  pw renewal-readiness", tone: "dim" },
    ],
  },
];
